...
EXECUTION_DATA_DIRPATH_ON_CLIENT_CONTAINER = "/data/sova-reth/execution-data"
...
def launch(
    ...
    sova_reth_metrics_info = node_metrics.new_node_metrics_info(
...
def get_config(
    ...
    if persistent:
        files[EXECUTION_DATA_DIRPATH_ON_CLIENT_CONTAINER] = Directory(
            ...
            if int(participant.el_volume_size) > 0
                ...
                constants.EL_TYPE.sova_reth + "_volume_size"
            ],
        )
    env_vars = {}
    ...
    config_args = {
        ...
        "labels": shared_utils.label_maker(
            client=constants.EL_TYPE.sova_reth,
